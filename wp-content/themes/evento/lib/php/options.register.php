<?php
    ...
    /*footer text */
    options::$fields['general']['footer_text']        = array('type' => 'st--textarea' , 'label' => __( 'Footer copyright text' , 'cosmotheme' ));
    ...
    options::$fields['layout']['attachment']            = array('type' => 'st--select' , 'label' => __( 'Layout for Attachment page' , 'cosmotheme' ) , 'value' => $layouts );
    ...
    /*PayPal Settings*/
    $general_hint = "This implementation works in conjunction with <a href='https://www.paypal.com/us/mrb/pal=KMEJ5UCMUQVAW'>PayPal&reg; Website Payments Standard</a>, for businesses. You do NOT need a PayPal&reg; Pro account. 
    				You just need to <a href='http://pages.ebay.com/help/buy/questions/upgrade-paypal-account.html'>upgrade</a> your Personal PayPal&reg; account to a Business status, which is free. A PayPal&reg; account can be upgraded from a 
    ...
    options::$fields['checkout']['general_hint']        = array('type' => 'st--hint' , 'value' => $general_hint );
