<?php
	class meta{
        ...
        static function sort_attached_custom_posts(){
            if(isset($_POST['action']) && $_POST['action'] == 'sort_attached_custom_posts'){
                if(isset($_POST['child_post_type']) && isset($_POST['post_id']) && isset($_POST['attached_ids']) ){
                    if(is_array($_POST['attached_ids']) && is_numeric($_POST['post_id']) ){
                        $sorted_attached_posts = array();
                        foreach ($_POST['attached_ids'] as $key => $value) {
                            $sorted_attached_posts[] = array('idrecord' => $value) ;
                        }

                        if(sizeof($sorted_attached_posts)){
                            update_post_meta( $_POST['post_id'], $_POST['child_post_type'], $sorted_attached_posts );
                        }
                    }
                }
            }   
