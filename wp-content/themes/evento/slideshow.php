                    ...
                    if( isset( $sl_item ) && !empty( $sl_item ) ){
                        if( $slider['type_res'] != 'program' ){
                            if( !empty( $sl_item -> post_excerpt ) ){
                                $description = trim( mb_substr( strip_tags( $sl_item -> post_excerpt  ) , 0 , 170 ) );
                                if( strlen( $sl_item -> post_excerpt ) > strlen( $description ) ){
                                    $description .= ' [...]';
                                }
                            }else{
                                $description = trim( mb_substr(  strip_tags( strip_shortcodes( $sl_item -> post_content ) ) , 0 , 170 ) );
                ...
                if( (int) $slider['slide_id'] > 0 ){
                    ...
                    if( isset( $sl_item ) ){
                        if( has_post_thumbnail( $sl_item -> ID ) ){
                            ...
                            $src[0] = get_template_directory_uri() . '/images/no_image940x300.jpg';
                        }
                    }
                }
