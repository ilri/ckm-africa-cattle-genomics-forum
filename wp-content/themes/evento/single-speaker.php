                                                    ...
                                                    <ul class="presentations speakers images ul">
	                                                    ...
	                                                    $info = meta::get_meta( $post -> ID , 'info' );
			                                                ...
			                                                if( !empty( $info ) && is_array( $info ) ){
                                                                $speaker_info = ''; /*initialize with empty string*/ 
                                                                if( isset( $info['country'] ) && !empty( $info['country'] ) ){
                                                                    $speaker_info .= '<li><span>' . __( 'Country' , 'cosmotheme' ) . ': </span>'  . $info['country'] . '</li>';
                                                                }

                                                                if( isset( $info['region'] ) && !empty( $info['region'] ) ){
                                                                    $speaker_info .= '<li><span>' . __( 'Region' , 'cosmotheme' ) . ': </span>' . $info['region'] . '</li>';
                                                                }

                                                                if( isset( $info['study'] ) && !empty( $info['study'] ) ){
                                                                    $speaker_info .= '<li><span>' . __( 'Studies' , 'cosmotheme' ) . ': </span>' . $info['study'] . '</li>';
                                                                }

                                                                if( isset( $info['university'] ) && !empty( $info['university'] ) ){
                                                                    $speaker_info .= '<li><span>' . __( 'University' , 'cosmotheme' ) . ': </span>' . $info['university'] . '</li>';
                                                                }

                                                                if( isset( $info['email'] ) && !empty( $info['email'] ) ){
                                                                    $speaker_info .= '<li><span>' . __( 'Email' , 'cosmotheme' ) . ': </span>' . $info['email'] . '</li>';
                                                                }

                                                                if(strlen($speaker_info)){
			                                            ?>
			                                                    <li class="info">
			                                            ...
			                                            ?>
			                                                    <li class="speaker_pr <?php if(!strlen($speaker_info)){ echo ' no_margin_top '; } ?> ">
